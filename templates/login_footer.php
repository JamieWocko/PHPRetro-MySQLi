...
<div id="footer">
	...
	<p<?php if($page['new_landing'] == true){ ?> class="copyright"<?php } ?>>Powered by <strong>PHPRetro</strong> &copy <?php echo(date("Y"));?> Yifan Lu, Based on HoloCMS By Meth0d<br /><?php echo $lang->loc['copyright.habbo']; ?></p>
