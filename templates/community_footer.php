...
$page['no_column3'] = isset($page['no_column3']) ? $page['no_column3'] : false;
?>
...
<div id="footer">
	...
	<p>Powered by <strong>PHPRetro</strong> &copy <?php echo(date("Y"));?> Yifan Lu, Based on HoloCMS By Meth0d<br /><?php echo $lang->loc['copyright.habbo']; ?></p>
