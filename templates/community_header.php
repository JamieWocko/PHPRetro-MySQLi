...
if(!isset($page['discussion'])){ $page['discussion'] = false; }
?>
...
<?php } ?>
<?php $page['cat'] = isset($page['cat']) ? $page['cat'] : ""; ?>
<ul id="navi">
...
<div id="navi2-container" class="pngbg">
    <div id="navi2" class="pngbg clearfix">
		<ul>
    		...
    		<li class="<?php if($page['id'] == "home" && ((isset($_GET['id']) && $_GET['id'] == $user->id) || (isset($_GET['name']) && $_GET['name'] == $user->name))){ echo "selected"; } ?>">
				<?php if($page['id'] == "home" && ((isset($_POST['name']) && $_POST['name'] == $user->name) || (isset($_GET['name']) && $_GET['name'] == $user->name))){ echo $lang->loc['my.page']; }else{ echo "<a href=\"".PATH."/home/".$user->name."\">".$lang->loc['my.page']."</a>"; } ?>
    		</li>
