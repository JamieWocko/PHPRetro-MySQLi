...
$page['name'] = isset($lang->loc['pagename.home']) ? $lang->loc['pagename.home'] : "Home";
$page['bodyid'] = "landing";

$var = isset($_GET['var1']) ? $_GET['var1'] : null;
$var2 = isset($_GET['var2']) ? $_GET['var2'] : null;
$date = HoloDate();

if(!isset($_POST['page']) && isset($_SESSION['page'])){ $_POST['page'] = $_SESSION['page']; }
...
case "submit":
	...
	$remember_me = isset($_POST['_login_remember_me']) ? $_POST['_login_remember_me'] : null;
	...
	if($_SESSION['login']['tries'] > 4 && $settings->find("site_capcha") == "1"){
		$captchaResponse = isset($_POST['captcha']) ? $_POST['captcha'] : (isset($_POST['bean_captchaResponse']) ? $_POST['bean_captchaResponse'] : "");
		if(($_SESSION['register-captcha-bubble'] == strtolower($captchaResponse) && !empty($_SESSION['register-captcha-bubble'])) || $settings->find("site_capcha") == "0") {
...
break;
case "logout":
	if(!isset($_GET['origin']) || $_GET['origin'] != "popup"){ require_once('./logout.php'); }
break;
case "logout_ok":
