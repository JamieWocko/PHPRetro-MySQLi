...
while ($row = $db->fetch_assoc($getem)) {
	$i++;
...
$lang->addLocale("widget.news"); ?>
        ...
        <div id="topstories">
	        ...
	        <div class="topstory" style="background-image: url(<?php echo $news[1]['header_image']; ?>)">
	            <h4><?php echo $lang->loc['latest.news']; ?></a></h4>
	        ...
	        <div class="topstory" style="background-image: url(<?php echo $news[2]['header_image']; ?>)">
	            <h4><?php echo $lang->loc['latest.news']; ?></a></h4>
