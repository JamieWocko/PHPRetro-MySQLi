...
if(isset($_POST['sendalert'])){ header('Location: '.PATH.'/housekeeping/alerts?do=create&type=single&userid='.$id); exit; }
...
<tr><td width="80"><?php echo $lang->loc['lastvisit']; ?>:</td><td><input type="text" disabled="true" value="<?php echo date('F n, Y g:i:s A',$cms_row['lastvisit']); ?>"></td></tr>
...
<input type="checkbox" style="width: auto" name="user" value="<?php echo $row[0]; ?>" /><label for="user"><?php echo $lang->loc['ban.user']; ?></label>&nbsp;&nbsp;<input type="checkbox" style="width: auto" name="ip" value="<?php echo $cms_row['ipaddress_last']; ?>" /><label for="ip"><?php echo $lang->loc['ban.ip']; ?></label>
</td></tr>
