...
$page = isset($_POST['page']) ? (int) $_POST['page'] : 1; if(empty($page)){ $page = 1; }
...
if(!empty($submit) && $submit == $continue){
	...
	switch($page){
		...
		case 3:
			...
			break;
		case 4:
			$last = $_POST['s_site_path'][strlen($_POST['s_site_path'])-1];
...
break;
case 5:
if(!isset($_SESSION['settings']['admin_username'])){ $_SESSION['settings']['admin_username'] = ""; }
if(!isset($_SESSION['settings']['admin_password'])){ $_SESSION['settings']['admin_password'] = ""; }
if(!isset($_SESSION['settings']['admin_email'])){ $_SESSION['settings']['admin_email'] = ""; }
