...
if(isset($_SESSION['username'])){ header("Location: ".PATH."/"); exit; }
//Referral
...
$figure = isset($_GET['figure']) ? $input->FilterText($_GET['figure']) : "";
$gender = isset($_GET['gender']) ? $input->FilterText($_GET['gender']) : "";
