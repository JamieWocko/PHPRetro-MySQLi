...
if($type == "token"){
	$_SESSION = array();
	$token = isset($_COOKIE['rememberme_token']) ? $input->FilterText($_COOKIE['rememberme_token']) : "";
	...
	$user = new HoloUser(isset($username) ? $username : null, isset($password) ? $password : null, true);
	$_SESSION['user'] = $user;
