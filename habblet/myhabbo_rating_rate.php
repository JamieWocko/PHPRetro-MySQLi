...
$ownerid = isset($_GET['ownerId']) ? $input->FilterText($_GET['ownerId']) : 0;
$widgetid = isset($_GET['ratingId']) ? $input->FilterText($_GET['ratingId']) : 0;
$rate = isset($_GET['givenRate']) ? $input->FilterText($_GET['givenRate']) : 0;
}
