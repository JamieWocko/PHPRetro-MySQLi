...
if(((isset($_SESSION['register-captcha-bubble']) && $_SESSION['register-captcha-bubble'] == $captcha) && !empty($_SESSION['register-captcha-bubble'])) || $settings->find("site_capcha") == "0"){
...
if($postrow['message'] ==  $lang->loc['post.deleted']){ exit; }
if($threadrow['open'] == "0"){ exit; }

$db->query("UPDATE ".PREFIX."forum_posts SET message = '".$message."', edit_time = '".time()."' WHERE id = '".$postrow['id']."' LIMIT 1");
