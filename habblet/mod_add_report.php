...
$type = isset($_GET['type']) ? $input->FilterText($_GET['type']) : "";
$id = isset($_POST['objectId']) ? $input->FilterText($_POST['objectId']) : "";

$count = isset($_SESSION['report_count']) ? $_SESSION['report_count'] : 0;
