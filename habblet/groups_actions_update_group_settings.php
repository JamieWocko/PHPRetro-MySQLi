...
$name = isset($_POST['name']) ? $input->FilterText($_POST['name']) : "";
$description = isset($_POST['description']) ? $input->FilterText($_POST['description']) : "";
$id = isset($_POST['groupId']) ? $input->FilterText($_POST['groupId']) : "";
$type = isset($_POST['type']) ? $input->FilterText($_POST['type']) : "0";
$url = isset($_POST['url']) ? $input->FilterText($_POST['url']) : "";
$forumType = isset($_POST['forumType']) ? $input->FilterText($_POST['forumType']) : "0";
$newTopicPermission = isset($_POST['newTopicPermission']) ? $input->FilterText($_POST['newTopicPermission']) : "0";
$roomId = isset($_POST['roomId']) ? $input->FilterText($_POST['roomId']) : "0";
