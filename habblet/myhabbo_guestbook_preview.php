...
$ownerid = isset($_POST['ownerId']) ? $input->HoloText($_POST['ownerId']) : "";
$message = isset($_POST['message']) ? $input->bbcode_format($input->HoloText($_POST['message'])) : "";
$scope = isset($_POST['scope']) ? $input->HoloText($_POST['scope']) : "";
$query = isset($_POST['query']) ? $input->HoloText($_POST['query']) : "";
$widgetid = isset($_POST['widgetId']) ? $input->HoloText($_POST['widgetId']) : "";
?>
