...
$message = nl2br($input->bbcode_format($input->HoloText(isset($_POST['message']) ? $_POST['message'] : "")));
$topicid = $input->HoloText(isset($_POST['topicId']) ? $_POST['topicId'] : "");
...
<tr class="post-list-index-preview">
	...
	<td class="post-list-message" valign="top" colspan="2">
        ...
        <span class="post-list-message-header">RE: <?php echo $input->HoloText($threadrow['title']); ?></span><br />
