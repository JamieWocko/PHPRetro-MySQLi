...
$maxlength = isset($_POST['maxlength']) ? $_POST['maxlength'] : 500;
$skin = isset($_POST['skin']) ? $_POST['skin'] : 1;
$scope = isset($_POST['scope']) ? $_POST['scope'] : "";
$query = isset($_POST['query']) ? $_POST['query'] : "";

if($user->user("rank") > 5){ $html = true; }else{ $html = false; }
$noteText = isset($_POST['noteText']) ? $_POST['noteText'] : "";
$note = nl2br($input->bbcode_format($input->HoloText($noteText,$html)));
...
$db->query("UPDATE ".PREFIX."homes SET skin = '".$skin."', variable = '".$input->FilterText($noteText)."', location = '-2', x = '10', y = '10', z = '".$zindex."', skin = '".$skin."' WHERE id = '".$row[0]."' LIMIT 1");
