...
$search = isset($_POST['tag']) ? $input->FilterText($_POST['tag']) : "";
...
?>
            ...
            <tr class="<?php echo $even; ?>">
                ...
                <td class="text">
                    <a href="<?php echo PATH; ?>/home/<?php echo $details[1]; ?>" class="result-title"><?php echo $details[1]; ?></a><br/>
...
if($search == "" || $count['total'] == 0){ $output = ""; }
?>
