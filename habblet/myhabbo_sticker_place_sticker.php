...
$id = isset($_POST['selectedStickerId']) ? $input->FilterText($_POST['selectedStickerId']) : "";
...
$db->query("UPDATE ".PREFIX."homes SET location = '".$location."', x = '20', y = '30', z = '".$zindex."' WHERE id = '".$id."' LIMIT 1");
