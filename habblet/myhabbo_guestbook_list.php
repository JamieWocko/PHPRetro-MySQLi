...
$owner = isset($_POST['ownerId']) ? $input->FilterText($_POST['ownerId']) : "";
$start = isset($_POST['lastEntryId']) ? $input->FilterText($_POST['lastEntryId']) : PHP_INT_MAX;
$widget = isset($_POST['widgetId']) ? $input->FilterText($_POST['widgetId']) : "";
}

$memberrow = array(0, 0, 0);
