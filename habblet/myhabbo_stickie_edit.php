...
$skin = isset($_POST['skinId']) ? $_POST['skinId'] : 1;
$id = isset($_POST['stickieId']) ? $input->FilterText($_POST['stickieId']) : "";

$pageEdit = isset($_SESSION['page_edit']) ? $_SESSION['page_edit'] : "home";
if($pageEdit == "home"){ $lang->location = -2; $where = '> -1'; }else{ $lang->location = "-".$pageEdit; $where = '< 1'; }
