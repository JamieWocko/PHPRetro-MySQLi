...
$id = isset($_POST['songId']) ? $input->FilterText($_POST['songId']) : "";
$widgetid = isset($_POST['widgetId']) ? $input->FilterText($_POST['widgetId']) : "";
$data = new home_sql;
...
wmode="transparent" flashvars="songUrl=<?php echo PATH; ?>/trax/song/<?php echo $id; ?>&amp;sampleUrl=/dcr/hof_furni//mp3/"
height="66" width="210" />
