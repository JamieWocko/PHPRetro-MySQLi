...
$id = isset($_POST['selectedId']) ? $input->FilterText($_POST['selectedId']) : "";
$task = isset($_POST['task']) ? $input->FilterText($_POST['task']) : "";
...
if($pageEdit == "home" && $row['where'] == -1){ $error = $lang->loc['purchase.error.1']; }
if($pageEdit != "home" && $row['where'] == 1){ $error = $lang->loc['purchase.error.1']; }
