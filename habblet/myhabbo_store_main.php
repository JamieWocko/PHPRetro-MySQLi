...
$category = isset($_POST['categoryId']) ? $input->FilterText($_POST['categoryId']) : 1;
$subcategory = isset($_POST['subCategoryId']) ? $input->FilterText($_POST['subCategoryId']) : -1;
...
if($pageEdit == "home"){ $where = '> -1'; }else{ $where = '< 1'; }
