...
$gender = isset($_POST['newGender']) ? $input->FilterText($_POST['newGender']) : "";
$figure = isset($_POST['figureData']) ? $input->FilterText($_POST['figureData']) : "";
...
header('X-JSON: {"daysLeft":'.$user->HCDaysLeft("self").'}');
?>
